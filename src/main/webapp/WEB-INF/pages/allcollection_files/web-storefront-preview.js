...
return this.each(function(e,t){r=new s(t,e)})}}(),jQuery(window).load(function(){jQuery(".screenshots .content").AppGallery({content:"div:first",image_wrapper:".lockup"})}),function(){jQuery.fn.Pill=function(){var e=jQuery(this).closest(".swoosh").find("div.content"),t=jQuery("div.screenshots div.pill a"),n,r=function(n){jQuery(n).each(function(n,r){n<1&&(jQuery(r).addClass("first active"),i(),jQuery(document.body).hasClass("social-preview")&&twttr.remote.ui("resizeFrame",jQuery(document.body).height())),jQuery(r).click(function(n){n.preventDefault(),n.stopPropagation();
if(!jQuery(this).hasClass("active")){var r=jQuery(this);
e.each(function(){jQuery(this).toggle()}),jQuery(".iphone-screen-shots").is(":visible")?jQuery("#watch-screenshots-swoosh").show():jQuery("#watch-screenshots-swoosh").hide(),t.each(function(){jQuery(this).removeClass("active")}),jQuery(this).addClass("active")}})});
var r=["490217893"];
...
t.length+d.length<400&&(dbg("openItunes: Attaching "+document.referrer),t+=f+"ign-msr="+d)}}}else!its.detect.itunesDetected()||t.indexOf("associateVPPUserWithITSAccount")===-1&&t.indexOf("vpp-associate")===-1?u?t="https://play.google.com/store/apps/details?id=com.apple.android.music&referrer=utm_source="+encodeURIComponent(t):t=itms.PageData.itunesDownloadUrl:t=t.replace(/^http/,"itms");
